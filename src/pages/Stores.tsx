...
const Stores: React.FC = () => {
  ...
  <div className="w-full md:w-3/4 pr-4 mb-4 md:mb-0">
    <h2 className="text-2xl text-gray-800 font-bold mb-2">{store.name}</h2>
    <div>
      <h3 className="text-lg font-semibold mb-2 text-gray-600">Stock:</h3>
      <div className="space-y-2 h-40 overflow-y-scroll border border-gray-200 rounded-md p-2 bg-gray-50">
        {store.inventory.map((item) => (
          <div key={item.product_id._id} className="p-2 border-b last:border-b-0 border-gray-200 text-lg text-gray-700 hover:bg-gray-100 transition duration-200">
